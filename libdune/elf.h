...
#define ELFMAG_U32                                                             \
	((uint32_t)(ELFMAG0 +                                                      \
				0x100 * (ELFMAG1 + (0x100 * (ELFMAG2 + 0x100 * ELFMAG3)))))
#elif __BYTE_ORDER == __BIG_ENDIAN
#define ELFMAG_U32                                                             \
	((uint32_t)((((ELFMAG0 * 0x100) + ELFMAG1) * 0x100 + ELFMAG2) * 0x100 +    \
				ELFMAG3))
#endif
...
#define R_V850_TDA_16_16_OFFSET                                                \
	16 /* For set1, clr1, not1, tst1,
					   movea, movhi */
/* CYGNUS LOCAL v850e */
...
#define R_NIOS_H_HI11                                                          \
	11 /* Top 11 bits of 16-bit absolute relocation in halfwords.  */
#define R_NIOS_H_XLO5                                                          \
	12 /* Low 5 bits of top 16-bits of 32-bit absolute relocation in halfwords.  */
#define R_NIOS_H_XHI11                                                         \
	13 /* Top 11 bits of top 16-bits of 32-bit absolute relocation in halfwords.  */
#define R_NIOS_H_16 14 /* Half-word @h value */
#define R_NIOS_H_32 15 /* Word @h value */
#define R_NIOS_GNU_VTINHERIT                                                   \
	200 /* GNU extension to record C++ vtable hierarchy */
#define R_NIOS_GNU_VTENTRY                                                     \
